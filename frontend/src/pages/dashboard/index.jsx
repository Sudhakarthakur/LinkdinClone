...
import { createPost, deletePost, getAboutUser, getAllComment, getAllPosts, incrementlike } from '@/config/redux/action/postAction';
...
export default function Dashboard() {
    ...
    const handleShare = async (post) => {
        ...
        if (navigator.share) {
            ...
            window.open(
                `https://wa.me/?text=${encodeURIComponent(post.body + "\n" + shareUrl)}`,
                "_blank"
            );
        }
    };
    // console.log(postState.posts);
    // console.log(postState.posts[0]._id);
                                ...
                                {postState.posts.map((post) => {
                                    return (
                                        <div key={post._id} className={styles.singleCard}>
                                            <div className={styles.singleCard__profileContaier}>
                                                ...
                                                <div>
                                                    <div style={{ display: "flex", gap: "1.2rem", justifyContent: "space-between" }}>
                                                        ...
                                                        {post.userId._id === authState.user.userId._id &&
                                                            <div onClick={async () => {
                                                                ...
                                                                <svg style={{ height: "1.2em", color: "red", cursor: "pointer", flexShrink: "0" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                                                    ...
                                                    <div className={styles.optionContainer} >
                                                        <div onClick={async () => {
                                                            ...
                                                            dispatch(getAllPosts())
                                                        }} className={styles.optionContainer__options}>
                                                            <svg style={{ width: "25%" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                        ...
                                                        <div className={styles.optionContainer__options}>
                                                            <svg style={{ width: "25%" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                        ...
                                                        <div onClick={() => {
                                                            ...
                                                            console.log(getAllComment({ post_id: post._id }))
                                                        }} className={styles.optionContainer__options}>
                                                            <svg style={{ width: "25%" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                                                                <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 9.75a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H8.25m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0H12m4.125 0a.375.375 0 1 1-.75 0 .375.375 0 0 1 .75 0Zm0 0h-.375m-13.5 3.01c0 1.6 1.123 2.994 2.707 3.227 1.087.16 2.185.283 3.293.369V21l4.184-4.183a1.14 1.14 0 0 1 .778-.332 48.294 48.294 0 0 0 5.83-.498c1.585-.233 2.708-1.626 2.708-3.228V6.741c0-1.602-1.123-2.995-2.707-3.228A48.394 48.394 0 0 0 12 3c-2.392 0-4.744.175-7.043.513C3.373 3.746 2.25 5.14 2.25 6.741v6.018Z" />
                                                            </svg>
                                                        </div>
                                                        <div className={styles.optionContainer__options} onClick={handleShare}>
                                                            <svg style={{ width: "25%" }} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
